// BoggleView.h : interface of the CBoggleView class
//
/////////////////////////////////////////////////////////////////////////////

#pragma once

//class CBoggleView : public CAxDialogImpl<CBoggleView>
//{
//public:
//	enum { IDD = /*IDD_BOGGLE_FORM */ IDD_MAINDLG };
//
...
class CBoggleView : public CAxDialogImpl<CBoggleView>, public CDialogResize<CBoggleView>,
		public CUpdateUI<CBoggleView>,	public CMessageFilter, public CIdleHandler
{
public:
	CDict m_dict;
	CBoard m_board;
	...
	enum { IDD = IDD_BOGGLE_FORM };

	CBoggleView() : m_board(&m_dict),
				 m_boardview(&m_board),
				 m_listview(&m_board),
				 m_connection(m_listview.connect(boost::bind(&CBoggleView::OnWordListSelection, this, _1)))
	{}
...
//		DLGRESIZE_CONTROL(IDC_TAB1, DLSZ_MOVE_X|DLSZ_SIZE_Y)
...
// void OnLButtonDown(UINT nFlags, CPoint point)
        ...
        CHAIN_MSG_MAP(CDialogResize<CBoggleView>)
	END_MSG_MAP()
...
//		CButton(GetDlgItem(IDC_NEW)).Click();
	...
	{
		CBoggleView* pThis = (CBoggleView*)p;
